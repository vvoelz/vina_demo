# colab_demo
A demo and tutorial for Autodock Vina that is designed to run on Googe Colab

`vina_demo.ipynb` [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/vvoelz/vina_demo/blob/main/colab_demo/vina_demo.ipynb)
